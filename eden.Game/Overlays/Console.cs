...
{
    public class Console : OverlayContainer, IKeyBindingHandler<EdenKeyBindings>
    {
        #region static
        ...
        public bool OnPressed(EdenKeyBindings action)
        {
            if (action == EdenKeyBindings.Console)
            {
                ToggleVisibility();
                return true;
            }
        ...
        public bool OnReleased(EdenKeyBindings action) => false;
